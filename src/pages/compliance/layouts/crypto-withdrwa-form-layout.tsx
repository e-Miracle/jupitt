...
const CryptoWithdrwaFormLayout: React.FC<ICountries> = ({ country }) => {
  ...
  return (
    <div>
      <div className="w-auto mx-auto  capitalize text-xl lg:text-2xl font-inter font-semibold text-center flex items-center justify-center">
        Crypto Withdraw
        {flag && (
          <img
...
export default CryptoWithdrwaFormLayout;
